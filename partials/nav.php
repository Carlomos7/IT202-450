...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?php echo get_url('home.php');?>">Shop Home</a>
        ...
        <div class="collapse navbar-collapse" id="navContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <?php if (is_logged_in()) : ?>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu bg-success" aria-labelledby="productsDropdown">
                            <li><a class="dropdown-item" href="<?php echo get_url('admin/add_products.php'); ?>">Sell</a></li>
                ...
                <?php if (has_role("Admin")) : ?>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="rolesDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Admin Roles</a>
